...
if($rowcount == 0){
	...
	<td><b><a href="account.php?q=quiz&step=2&eid='.$eid.'&n=1&t='.$total.'<span class="glyphicon glyphicon-new-window" aria-hidden="true"></span>&nbsp;</a></b></td></tr>';
}
else
{
...
echo  '<div class="panel"><div class="table-responsive"><table class="table table-striped title1">
<tr><td><b>S.N.</b></td><td><b>Subject</b></td><td><b>Email</b></td><td><b>Date</b></td><td><b>Time</b></td><td><b>By</b></td><td><b>Open</b></td><td><b>Delete</b></td></tr>';
$c=1;
while($row = mysqli_fetch_array($result)) {
	$date = $row['date'];
...
<div class="form-group">
  ...
  <div class="col-md-12">
  Enter Quiz title :<input id="name" name="name"  class="form-control input-md" type="text">
...
<div class="form-group">
  ...
  <div class="col-md-12">
  Enter total number of questions: <input id="total" name="total" class="form-control input-md" type="number">
...
<div class="form-group">
  ...
  <div class="col-md-12">
  Enter marks on right answer : <input id="right" name="right"  class="form-control input-md" min="0" type="number">
...
<div class="form-group">
  ...
  <div class="col-md-12">
  Enter minus marks on wrong answer without sign :<input id="wrong" name="wrong"  class="form-control input-md" min="0" type="number">
...
<div class="form-group">
  ...
  <div class="col-md-12">
  Enter time limit for test in minute :<input id="time" name="time"  class="form-control input-md" min="1" type="number">
...
<div class="form-group">
  ...
  <div class="col-md-12">
 Write description here... <textarea rows="8" cols="8" name="desc" class="form-control" ></textarea>  
  </div>
</div>
...
<div class="row footer">
        ...
        <a href="https://www.apsit.edu.in/home" target="_blank">About us</a>
        </div>
        <div class="col-md-3 box">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <div class="row">
                <div class="col-md-4">
                 <img src="quiz.jpg" width=100 height=100 alt="Quiz" class="img-rounded">
                 </div>
                 <div class="col-md-5">
                <a href="https://www.google.com/" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Ekta Gujar</a>
                <h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">1234567892</h4>
                <h4 style="font-family:'typo' ">ram111@gmail.com</h4>
                <h4 style="font-family:'typo' ">A. P. Shah Institute of Technology</h4></div></div>
                </p>
            <p>
                <div class="row">
                <div class="col-md-4">
                 <img src="quiz1.jpg" width=100 height=100 alt="Quiz" class="img-rounded">
                 </div>
                 <div class="col-md-5">
                <a href="https://www.google.com/" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Sindura Dasi</a>
                <h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">5214365221</h4>
                <h4 style="font-family:'typo' ">ray111@gmail.com</h4>
                <h4 style="font-family:'typo' ">A. P. Shah Institute of Technology</h4></div></div>
                </p>
              </div>
...
<footer style="text-align:center"><b>
    &copy; A. P. Shah Institute of Technology</b>
</footer>
<!--footer end-->
</body>
</html>
